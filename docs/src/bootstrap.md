...
The following manifest creates a new PostgreSQL 14.3 cluster,
...
the same PostgreSQL version (in our case 14.3).
...
The manifest defines a new PostgreSQL 14.3 cluster called `cluster-clone-tls`,
